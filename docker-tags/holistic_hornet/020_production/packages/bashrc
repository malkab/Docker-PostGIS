...
# For the mlk-git-backup, mlk-git-backup-all, and mlk-git-status scripts
export MLK_GIT_BACKUP_LOCAL=/Users/malkab/Dropbox/docs/backups/git-repos
export MLK_GIT_BACKUP_REMOTE=malkab@tie:/home/git/backups-erebus-repos
export MLK_GIT_HOME=/home/git
