PostgreSQL 9.6.5, PostGIS 2.3.3, GDAL 2.1.4, Patched
===
...
```Shell
docker pull malkab/postgis:awaken_amazon
```
...
docker run --rm -ti -v /home/malkab/Desktop/:/d --link test_07:pg \ malkab/postgis:awaken_amazon \ PGPASSWORD="new_password_here" psql -h pg -p 5432 -U postgres postgres
```
